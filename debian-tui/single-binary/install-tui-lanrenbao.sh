...
#
# Ships the backend `tad-module` (author's official v0.10.19 static binary, from
...
TANK_RELEASE_TANK="${TANK_RELEASE_TANK:-https://github.com/luodaoyi/TAD6S4N10G-fnos/releases/download/v0.10.19/tank-linux-amd64}"
TANK_RELEASE_BACKEND="${TANK_RELEASE_BACKEND:-https://github.com/luodaoyi/TAD6S4N10G-fnos/releases/download/v0.10.19/tad-module.fpk}"
